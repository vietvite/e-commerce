        ...
        <div className={style.footerSection}>
          <div className={style.footerHead}>
            <div className={style.footerHeadLeft}>
              E-COMMERCE - Sàn thương mại điện tử xuyên biên giới hàng đầu Việt
              Nam
              <br />
            ...
            <div className={style.footerBodyCenter}>
              ...
              <div className={style.footerDesInfo}>
                ...
                <div className={style.footerContents}>
                  ...
                  vụ mua sắm trực tiếp tốt nhất tại Việt Nam ,vận chuyển đến tận
                  tay quý khách hàng một cách nhanh chóng, an toàn với chi phí
                  tiết kiệm nhất.
                  <br />
                  ...
                  <br />
                  Thanh toán bằng nhiều hình thức rất tiện lợi, có thể trực tiếp
                  quản lý và theo dõi trạng thái đơn hàng của mình. Với giao
                  diện thân thiện,dễ sử dụng, E-COMMERCE phục vụ khách hàng
                  24/24 và tin đăng của bạn sẽ được bảo vệ an toàn nhất.
                  <br />
                  Tại đây, người bán khi đăng kí làm thành viên của E-COMMERCE
                  đều có quyền ngang nhau, được tự do xây dựng gian hàng và đăng
                  tải những tin đăng có nội dung phong phú,đẹp mắt. Ngược lại,
                  người mua luôn có nhiều lựa chọn để có được hàng hóa tốt nhất.
                  <br />
                  E-COMMERCE không ngừng nâng cấp,cải tiến,mong muốn những dịch
                  vụ của mình sẽ đem đến cho quý khách hàng mọi thông tin bạn
                  cần bất cứ lúc nào, ở bất kỳ đâu với chất lượng cao nhất.
                  <br />
            ...
            <div className={style.footerBodyRight}>
              <div className={style.footerRegisterMail}>
                ...
                <div className={style.footerRegisterDes}>
                  Nếu bạn mong muốn thử sức trên lĩnh vực kinh doanh, đừng ngần
                  ngại hãy biến mình trở thành một thành viên trong đại gia đình
                  XXX.
                </div>
                <form
